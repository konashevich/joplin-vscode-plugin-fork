export type TranslateParams =
  ...
  | [key: 'Joplin is already in the workspace']
  | [
      key: 'Joplin notebooks added to workspace. AI agents can now access your notes.',
    ]
  | [key: 'Failed to add Joplin to workspace']
